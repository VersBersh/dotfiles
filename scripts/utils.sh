...
# best practice shell functions for building scripts
...
# DESC: shell-agnostic regex match
# ARGS: $1 (required): target string
#       $2 (required): pattern
# NOTE: https://stackoverflow.com/questions/22537804/
# shellcheck disable=SC2034  # reMatch variable unused
function reMatch {
  if [[ $# -ne 2 ]]; then
      script_exit "Invalid arguments passed to reMatch()!" 2
  fi
